...
parser.add_argument('--lr_init', '-lr', type=float, default=0.5)
parser.add_argument('--decay_rate', '-dr', type=float, default=0.2)
parser.add_argument('--decay_steps', '-ds', nargs='*', type=int, default=[35])
...
num_workers = 1 if torch.cuda.is_available() else 16
